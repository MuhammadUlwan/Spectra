<template>
  ...
  >
    <div class="p-4 md:p-6 flex flex-col gap-6">
      ...
      <!-- Saldo Card -->
      <div class="w-full bg-white rounded-xl p-5 shadow-md flex justify-between items-center border border-gray-200">
      ...
      <!-- Form Tarik Tunai -->
      <div class="w-full bg-gradient-to-br from-blue-500 to-green-400 rounded-xl p-6 shadow-md text-white">
        <div class="mb-4">
      ...
      <transition name="fade">
        <div v-if="message" :class="[ 
          'w-full mt-4 p-4 rounded-xl text-sm flex items-center',
